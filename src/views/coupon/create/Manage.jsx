...
{this.props.parent === "order" ? (null) : (
  <div  className="mb-sm-30">
  <Breadcrumb
    routeSegments={[
      { name: "Coupons", path: "/Coupon/manage" },
      { name: "Create" }
    ]}
  />
</div>
...
<div style = {{margin : "30px", marginBottom : "10px", display : "flex", flexDirection : "row", justifyContent : "space-between" }}>
...
status: "Active",
    ...
    this.setState({create_edit_dialog : true}) 
          ...
          <div className="container" style={{height: "100%", width : "90%", margin : "5%", marginTop : "0%"}}>
